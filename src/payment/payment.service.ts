...
export class PaymentService {
  ...
  public registerPaymentOrder(payment: Payment): Payment {
    payment.priceInstallments = this.calculateInstallments(payment.paymentInstallments, payment.totalValue)
  ...
  private calculateInstallments(installments: number, totalValue: number): number {
